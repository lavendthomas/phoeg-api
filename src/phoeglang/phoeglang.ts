...
const grammar: Grammar = {
  ...
  ParserRules: [
    ...
    { name: "power", symbols: ["number"], postprocess: id },
    {
      name: "number",
      symbols: ["decimal"],
      postprocess: (d) => d[0].toString(),
    },
    {
      name: "number",
      symbols: ["invariant"],
      postprocess: (d) => d[0].toString() + ".val",
    },
