...
const grammar: Grammar = {
  ...
  ParserRules: [
    ...
    {"name": "negation", "symbols": ["negation$subexpression$2", "_", {"literal":"("}, "_", "condition", "_", {"literal":")"}], "postprocess": (d) => "NOT (" + d[4] + ")"},
    ...
    {"name": "condition", "symbols": ["condition", "_", "condition$subexpression$1", "_", "expression"], "postprocess": (d) => "(" + d[0] + ")" + "="  + "(" + d[4] + ")"},
    ...
    {"name": "condition", "symbols": ["condition", "_", "condition$subexpression$2", "_", "expression"], "postprocess": (d) => "(" + d[0] + ")" + "<>" + "(" + d[4] + ")"},
    ...
    {"name": "expression", "symbols": ["expression$string$2", "_", "parenthesed_term_list"], "postprocess": (d) => "LEAST" + d[2]},
    {"name": "expression$string$3", "symbols": [{"literal":"S"}, {"literal":"U"}, {"literal":"M"}], "postprocess": (d) => d.join('')},
    {"name": "expression", "symbols": ["expression$string$3", "_", "parenthesed_term_list"], "postprocess": (d) => "SUM" + d[2]},
    {"name": "expression$string$4", "symbols": [{"literal":"A"}, {"literal":"V"}, {"literal":"G"}], "postprocess": (d) => d.join('')},
    {"name": "expression", "symbols": ["expression$string$4", "_", "parenthesed_term_list"], "postprocess": (d) => "AVG" + d[2]},
    {"name": "expression$string$5", "symbols": [{"literal":"M"}, {"literal":"E"}, {"literal":"A"}, {"literal":"N"}], "postprocess": (d) => d.join('')},
    {"name": "expression", "symbols": ["expression$string$5", "_", "parenthesed_term_list"], "postprocess": (d) => "MEAN" + d[2]},
