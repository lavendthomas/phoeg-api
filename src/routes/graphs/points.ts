...
import { condition, part_select_count, part_from, part_where_val, part_json_build_object, part_from_data, part_invariants_to_json } from "./utils";
...
const all_invariant_names = [...new Set(all_form_invariants.concat(all_phoeglang_invariants))];
  ...
  raw_query = part_invariants_to_json(invariants);
